...
{
    const string AppKey = "77f7cbe6b5162eaa";//AppKey和AppSecret是本人@Ryu申请的账号，仅供测试使用
    const string LangEn = "en";
    const string AppSecret = "OQH4o0jnIiwYekSZUyyPJshf8pEarHLP";
    ...
    public class YouDaoTranslationResponse
    {
        ...
        ///// </summary>
        //[DataMember(Name = "web")]
        //public List<TranslationWebData> WebTranslation { get; set; }
    }
